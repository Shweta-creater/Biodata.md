...
|:----:|:-----:|:-----:|:-----:|:-----:|
|1|**Comparing Output* |Comparing outputs of both the file without any changes in the spreadsheet |Match of both the files|**PASS**| |2|**Adding Column* |Comparing outputs generated by our Testscrip|Match of both the files|**PASS** |
